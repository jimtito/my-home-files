...
document.title="xkcd | " + document.title.substring(20);
...
single("/html/body/div/div[2]/div/div").appendChild(new Element("h3", {
	innerHTML : "Original / Full page: <a href=\""+location.pathname+"?full=true\">http://xkcd.com"+location.pathname+"?full=true</a>"
}));
document.addEventListener("keydown",function(e){
	const cur=Number(/\d+/.exec(document.evaluate("/html/body/div/div[2]/div/div/h3/a/text()",document,null,2,null).stringValue)[0]);
