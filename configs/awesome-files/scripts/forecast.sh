...
<title>userscripts/forecast.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/forecast.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/forecast.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/forecast.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh"># you need conkyForecast script to use this one</pre></td>
</tr>
<tr id="line4">
...
<td class="code"><pre class="prettyprint lang-sh">LOCATION=RSXX0091</pre></td>
</tr>
<tr id="line6">
...
<td class="code"><pre class="prettyprint lang-sh">ICON=`conkyForecast --location=$LOCATION --datatype=WF | tail -n 1`</pre></td>
</tr>
<tr id="line8">
<td class="line-numbers"><a href="#line8" name="line8">8</a></td>
<td class="code"><pre class="prettyprint lang-sh">TEMP=`conkyForecast --location=$LOCATION --datatype=HT | tail -n 1`</pre></td>
</tr>
<tr id="line9">
...
<td class="code"><pre class="prettyprint lang-sh">if echo &quot;$ICON&quot; | grep -q &quot;No&quot;; then</pre></td>
</tr>
<tr id="line11">
<td class="line-numbers"><a href="#line11" name="line11">11</a></td>
<td class="code"><pre class="prettyprint lang-sh">    echo -n &quot;e N/A&quot;</pre></td>
</tr>
<tr id="line12">
<td class="line-numbers"><a href="#line12" name="line12">12</a></td>
<td class="code"><pre class="prettyprint lang-sh">else</pre></td>
</tr>
<tr id="line13">
<td class="line-numbers"><a href="#line13" name="line13">13</a></td>
<td class="code"><pre class="prettyprint lang-sh">    echo -n &quot;$ICON $TEMP&quot;</pre></td>
</tr>
<tr id="line14">
