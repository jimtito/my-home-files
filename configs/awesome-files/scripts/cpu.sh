...
<title>userscripts/cpu.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/cpu.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/cpu.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/cpu.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh">#!/bin/bash</pre></td>
</tr>
<tr id="line2">
<td class="line-numbers"><a href="#line2" name="line2">2</a></td>
<td class="code"><pre class="prettyprint lang-sh"># by Paul Colby (http://colby.id.au), no rights reserved ;)</pre></td>
</tr>
<tr id="line3">
...
<td class="code"><pre class="prettyprint lang-sh"># change this with your temporary files</pre></td>
</tr>
<tr id="line5">
<td class="line-numbers"><a href="#line5" name="line5">5</a></td>
<td class="code"><pre class="prettyprint lang-sh">TMP1=&quot;/dev/shm/tmp/cpuusage.total&quot;</pre></td>
</tr>
<tr id="line6">
<td class="line-numbers"><a href="#line6" name="line6">6</a></td>
<td class="code"><pre class="prettyprint lang-sh">TMP2=&quot;/dev/shm/tmp/cpuusage.idle&quot;</pre></td>
</tr>
<tr id="line7">
...
<td class="code"><pre class="prettyprint lang-sh">if [ ! -s &quot;$TMP1&quot; ]; then</pre></td>
</tr>
<tr id="line9">
<td class="line-numbers"><a href="#line9" name="line9">9</a></td>
<td class="code"><pre class="prettyprint lang-sh">	touch &quot;$TMP1&quot;</pre></td>
</tr>
<tr id="line10">
<td class="line-numbers"><a href="#line10" name="line10">10</a></td>
<td class="code"><pre class="prettyprint lang-sh">	echo 0 &gt; &quot;$TMP1&quot;</pre></td>
</tr>
<tr id="line11">
<td class="line-numbers"><a href="#line11" name="line11">11</a></td>
<td class="code"><pre class="prettyprint lang-sh">fi</pre></td>
</tr>
<tr id="line12">
...
<td class="code"><pre class="prettyprint lang-sh">if [ ! -s &quot;$TMP2&quot; ]; then</pre></td>
</tr>
<tr id="line14">
<td class="line-numbers"><a href="#line14" name="line14">14</a></td>
<td class="code"><pre class="prettyprint lang-sh">	touch &quot;$TMP2&quot;</pre></td>
</tr>
<tr id="line15">
<td class="line-numbers"><a href="#line15" name="line15">15</a></td>
<td class="code"><pre class="prettyprint lang-sh">	echo 0 &gt; &quot;$TMP2&quot;</pre></td>
</tr>
<tr id="line16">
...
<td class="code"><pre class="prettyprint lang-sh">#PREV_TOTAL=0</pre></td>
</tr>
<tr id="line19">
<td class="line-numbers"><a href="#line19" name="line19">19</a></td>
<td class="code"><pre class="prettyprint lang-sh">#PREV_IDLE=0</pre></td>
</tr>
<tr id="line20">
...
<td class="code"><pre class="prettyprint lang-sh">#while true; do</pre></td>
</tr>
<tr id="line23">
<td class="line-numbers"><a href="#line23" name="line23">23</a></td>
<td class="code"><pre class="prettyprint lang-sh">  PREV_TOTAL=`cat ${TMP1}`</pre></td>
</tr>
<tr id="line24">
<td class="line-numbers"><a href="#line24" name="line24">24</a></td>
<td class="code"><pre class="prettyprint lang-sh">  PREV_IDLE=`cat ${TMP2}`</pre></td>
</tr>
<tr id="line25">
...
<td class="code"><pre class="prettyprint lang-sh">  CPU=(`cat /proc/stat | grep '^cpu '`) # Get the total CPU statistics.</pre></td>
</tr>
<tr id="line27">
<td class="line-numbers"><a href="#line27" name="line27">27</a></td>
<td class="code"><pre class="prettyprint lang-sh">  unset CPU[0]                          # Discard the &quot;cpu&quot; prefix.</pre></td>
</tr>
<tr id="line28">
<td class="line-numbers"><a href="#line28" name="line28">28</a></td>
<td class="code"><pre class="prettyprint lang-sh">  IDLE=${CPU[4]}                        # Get the idle CPU time.</pre></td>
</tr>
<tr id="line29">
...
<td class="code"><pre class="prettyprint lang-sh">  # Calculate the total CPU time.</pre></td>
</tr>
<tr id="line31">
<td class="line-numbers"><a href="#line31" name="line31">31</a></td>
<td class="code"><pre class="prettyprint lang-sh">  TOTAL=0</pre></td>
</tr>
<tr id="line32">
<td class="line-numbers"><a href="#line32" name="line32">32</a></td>
<td class="code"><pre class="prettyprint lang-sh">  for VALUE in &quot;${CPU[@]}&quot;; do</pre></td>
</tr>
<tr id="line33">
<td class="line-numbers"><a href="#line33" name="line33">33</a></td>
<td class="code"><pre class="prettyprint lang-sh">    let &quot;TOTAL=$TOTAL+$VALUE&quot;</pre></td>
</tr>
<tr id="line34">
<td class="line-numbers"><a href="#line34" name="line34">34</a></td>
<td class="code"><pre class="prettyprint lang-sh">  done</pre></td>
</tr>
<tr id="line35">
...
<td class="code"><pre class="prettyprint lang-sh">  # Calculate the CPU usage since we last checked.</pre></td>
</tr>
<tr id="line37">
<td class="line-numbers"><a href="#line37" name="line37">37</a></td>
<td class="code"><pre class="prettyprint lang-sh">  let &quot;DIFF_IDLE=$IDLE-$PREV_IDLE&quot;</pre></td>
</tr>
<tr id="line38">
<td class="line-numbers"><a href="#line38" name="line38">38</a></td>
<td class="code"><pre class="prettyprint lang-sh">  let &quot;DIFF_TOTAL=$TOTAL-$PREV_TOTAL&quot;</pre></td>
</tr>
<tr id="line39">
<td class="line-numbers"><a href="#line39" name="line39">39</a></td>
<td class="code"><pre class="prettyprint lang-sh">  let &quot;DIFF_USAGE=(1000*($DIFF_TOTAL-$DIFF_IDLE)/$DIFF_TOTAL+5)/10&quot;</pre></td>
</tr>
<tr id="line40">
<td class="line-numbers"><a href="#line40" name="line40">40</a></td>
<td class="code"><pre class="prettyprint lang-sh">  echo -n &quot;$DIFF_USAGE&quot;</pre></td>
</tr>
<tr id="line41">
...
<td class="code"><pre class="prettyprint lang-sh">  # Remember the total and idle CPU times for the next check.</pre></td>
</tr>
<tr id="line43">
<td class="line-numbers"><a href="#line43" name="line43">43</a></td>
<td class="code"><pre class="prettyprint lang-sh">  #PREV_TOTAL=&quot;$TOTAL&quot;</pre></td>
</tr>
<tr id="line44">
<td class="line-numbers"><a href="#line44" name="line44">44</a></td>
<td class="code"><pre class="prettyprint lang-sh">  #PREV_IDLE=&quot;$IDLE&quot;</pre></td>
</tr>
<tr id="line45">
<td class="line-numbers"><a href="#line45" name="line45">45</a></td>
<td class="code"><pre class="prettyprint lang-sh">  echo $TOTAL &gt; &quot;$TMP1&quot;</pre></td>
</tr>
<tr id="line46">
<td class="line-numbers"><a href="#line46" name="line46">46</a></td>
<td class="code"><pre class="prettyprint lang-sh">  echo $IDLE &gt; &quot;$TMP2&quot;</pre></td>
</tr>
<tr id="line47">
...
<td class="code"><pre class="prettyprint lang-sh">  # Wait before checking again.</pre></td>
</tr>
<tr id="line49">
<td class="line-numbers"><a href="#line49" name="line49">49</a></td>
<td class="code"><pre class="prettyprint lang-sh">#  sleep 1</pre></td>
</tr>
<tr id="line50">
