...
<title>userscripts/xkb.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/xkb.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/xkb.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/xkb.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh"># you need either getxkblayout script ot xkblayout-state app to use this script</pre></td>
</tr>
<tr id="line4">
...
<td class="code"><pre class="prettyprint lang-sh">#echo -n `getxkblayout` | tr '[:lower:]' '[:upper:]'</pre></td>
</tr>
<tr id="line6">
<td class="line-numbers"><a href="#line6" name="line6">6</a></td>
<td class="code"><pre class="prettyprint lang-sh">echo -n `xkblayout-state print %e` | tr '[:lower:]' '[:upper:]'</pre></td>
</tr>
</table>  
