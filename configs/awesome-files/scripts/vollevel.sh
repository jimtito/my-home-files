...
<title>userscripts/vollevel.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/vollevel.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/vollevel.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/vollevel.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh">#amixer get Master | grep &quot;Front Left:&quot; | awk '{print $5}' &gt; /tmp/vollevel.out</pre></td>
</tr>
<tr id="line5">
<td class="line-numbers"><a href="#line5" name="line5">5</a></td>
<td class="code"><pre class="prettyprint lang-sh">#RES=$( cat /tmp/vollevel.out )</pre></td>
</tr>
<tr id="line6">
...
<td class="code"><pre class="prettyprint lang-sh">RES=$( amixer get $1 | grep &quot;Front Left:&quot; | awk '{print $5}' )</pre></td>
</tr>
<tr id="line8">
<td class="line-numbers"><a href="#line8" name="line8">8</a></td>
<td class="code"><pre class="prettyprint lang-sh">#echo -e $RES</pre></td>
</tr>
<tr id="line9">
<td class="line-numbers"><a href="#line9" name="line9">9</a></td>
<td class="code"><pre class="prettyprint lang-sh">#RES=&quot;[30%]&quot;</pre></td>
</tr>
<tr id="line10">
<td class="line-numbers"><a href="#line10" name="line10">10</a></td>
<td class="code"><pre class="prettyprint lang-sh">RES=${RES##&quot;[&quot;}</pre></td>
</tr>
<tr id="line11">
...
<td class="code"><pre class="prettyprint lang-sh">echo -n $RES #&gt; /tmp/vollevel.out</pre></td>
</tr>
</table>  
