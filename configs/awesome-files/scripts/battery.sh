...
<title>userscripts/battery.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/battery.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/battery.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/battery.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh">STATUS=$( acpi | awk '{print $3}' )</pre></td>
</tr>
<tr id="line4">
...
<td class="code"><pre class="prettyprint lang-sh">if [ &quot;$STATUS&quot; = &quot;Discharging,&quot; ]</pre></td>
</tr>
<tr id="line6">
<td class="line-numbers"><a href="#line6" name="line6">6</a></td>
<td class="code"><pre class="prettyprint lang-sh">then</pre></td>
</tr>
<tr id="line7">
<td class="line-numbers"><a href="#line7" name="line7">7</a></td>
<td class="code"><pre class="prettyprint lang-sh">	STATUS=&quot;A&quot;</pre></td>
</tr>
<tr id="line8">
...
<td class="code"><pre class="prettyprint lang-sh">	STATUS=&quot;AC&quot;</pre></td>
</tr>
<tr id="line10">
...
<td class="code"><pre class="prettyprint lang-sh">PERCENT=$( acpi | awk '{print $4}' )</pre></td>
</tr>
<tr id="line13">
<td class="line-numbers"><a href="#line13" name="line13">13</a></td>
<td class="code"><pre class="prettyprint lang-sh">PERCENT=${PERCENT%%&quot;%,&quot;}</pre></td>
</tr>
<tr id="line14">
...
<td class="code"><pre class="prettyprint lang-sh">echo -n &quot;$STATUS $PERCENT&quot;</pre></td>
</tr>
</table>  
