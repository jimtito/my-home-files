...
<title>userscripts/runner.sh - bashets in bashets - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/bashets/bashets/blobs/blame/b8dd569f9ebf86af94405a4b3bb030e9a2dd7ebf/userscripts/runner.sh" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/bashets/bashets/blobs/history/master/userscripts/runner.sh" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/bashets/bashets/blobs/raw/master/userscripts/runner.sh">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-sh">	echo &quot;bashets.external_w(\&quot;`$1 | sed '{:q;N;s/\n/\\\n/g;t q}'`\&quot;, \&quot;$2\&quot;)&quot; | awesome-client</pre></td>
</tr>
<tr id="line5">
<td class="line-numbers"><a href="#line5" name="line5">5</a></td>
<td class="code"><pre class="prettyprint lang-sh">	sleep $3</pre></td>
</tr>
<tr id="line6">
