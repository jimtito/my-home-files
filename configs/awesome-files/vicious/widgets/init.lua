...
require("vicious.widgets.aptitude")
require("vicious.widgets.omnibook")
require("vicious.widgets.sonybright")
require("vicious.widgets.touchpad")
require("vicious.widgets.vaiopower")
-- }}}
