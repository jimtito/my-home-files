...
hi Visual	        term=bold,reverse cterm=bold,reverse ctermfg=red ctermbg=black gui=bold,reverse guifg=gray40 guibg=black
...
hi DiffChange	    term=bold ctermbg=darkgreen guibg=maroon
hi DiffDelete     	term=bold cterm=bold ctermfg=lightblue ctermbg=cyan gui=bold guifg=lightblue guibg=cyan4
hi DiffText	        term=reverse cterm=bold ctermbg=darkgray gui=bold guibg=red3
hi Cursor       	guifg=bg guibg=fg
hi lCursor      	guifg=bg guibg=fg
hi StatusLine	    term=reverse cterm=reverse gui=reverse guifg=darkgray
hi StatusLineNC 	term=reverse cterm=reverse gui=reverse guifg=gray40
hi VertSplit	    term=reverse cterm=reverse gui=bold,reverse guifg=gray40
hi Title        	term=bold ctermfg=darkmagenta gui=bold guifg=aquamarine
...
hi Error	        term=reverse ctermfg=black ctermbg=blue guifg=gray guibg=red3
